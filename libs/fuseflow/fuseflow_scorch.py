...
from honey_lang import Helper, Input, Output, Function, initialize, log
...
class ScheduleState:
    ...
    @classmethod
    def annotate_tensor_format(
        cls, tensor_name, format_name, index_names, sparsity_pattern
    ):
        if len(index_names) != len(sparsity_pattern):
            raise ValueError(
                "index_names and sparsity_pattern must have matching length"
            )
        entry = cls._ensure_tensor_entry(tensor_name)
...
def annotate_tensor_csr(
    __hb_level: TensorAnnotationLevel, __hb_ret: TensorAnnotationDone
):
    names = __hb_level.indices.split()
    ScheduleState.annotate_tensor_format(
        __hb_level.tensor_name, "CSR", names, [True, False]
    )
    print(
        f"Annotated '{__hb_level.tensor_name}' as CSR: {names[0]}=sparse, {names[1]}=dense."
    )
...
def annotate_tensor_csc(
    __hb_level: TensorAnnotationLevel, __hb_ret: TensorAnnotationDone
):
    names = __hb_level.indices.split()
    ScheduleState.annotate_tensor_format(
        __hb_level.tensor_name, "CSC", names, [False, True]
    )
    print(
        f"Annotated '{__hb_level.tensor_name}' as CSC: {names[0]}=dense, {names[1]}=sparse."
    )
...
def annotate_tensor_coo(
    __hb_level: TensorAnnotationLevel, __hb_ret: TensorAnnotationDone
):
    names = __hb_level.indices.split()
    ScheduleState.annotate_tensor_format(
        __hb_level.tensor_name, "COO", names, [True, True]
    )
    print(
        f"Annotated '{__hb_level.tensor_name}' as COO: {names[0]},{names[1]} both sparse."
    )
...
def begin_custom_annotation(
    __hb_level: TensorAnnotationLevel, __hb_ret: TensorIndexLevel
):
    names = __hb_level.indices.split()
...
def finish_custom_after_index_0(
    __hb_prev: TensorIndexChoice, __hb_ret: TensorAnnotationDone
):
...
def finish_custom_after_index_1(
    __hb_prev: TensorIndexChoice, __hb_ret: TensorAnnotationDone
):
    print(f"Finished custom annotation of '{__hb_prev.tensor_name}'.")
...
def finish_custom_after_index_2(
    __hb_prev: TensorIndexChoice, __hb_ret: TensorAnnotationDone
):
    print(f"Finished custom annotation of '{__hb_prev.tensor_name}'.")
...
def finish_custom_after_index_3(
    __hb_prev: TensorIndexChoice, __hb_ret: TensorAnnotationDone
):
    print(f"Finished custom annotation of '{__hb_prev.tensor_name}'.")
...
def advance_tensor_annotation_1(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_2(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_3(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_4(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_5(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_6(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_7(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_8(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_9(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_10(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_11(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_12(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_13(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_14(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def advance_tensor_annotation_15(
    __hb_prev: TensorAnnotationDone, __hb_ret: TensorAnnotationLevel
):
...
def finish_annotation_after_tensor_0(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
...
def finish_annotation_after_tensor_1(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_2(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_3(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_4(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_5(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_6(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_7(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_8(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_9(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_10(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_11(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_12(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_13(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_14(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def finish_annotation_after_tensor_15(
    __hb_done: TensorAnnotationDone, __hb_ret: SparseAnnotationPass
):
    print("Sparse annotation complete.")
...
def begin_par_factor_selection(
    __hb_vec: VectorizationPass, __hb_ret: ParFactorLevelChoice
):
    ScheduleState.initialize_parallel_schedule(
        num_loops=__hb_vec.num_loops, max_levels=16
    )
...
def advance_par_factor_level_1(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_2(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_3(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_4(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_5(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_6(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_7(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_8(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_9(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_10(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_11(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_12(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_13(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_14(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def advance_par_factor_level_15(
    __hb_prev: ParFactorChoice, __hb_ret: ParFactorLevelChoice
):
...
def choose_default_par_factor(
    __hb_level: ParFactorLevelChoice, __hb_ret: ParFactorChoice
):
...
def choose_default_stream_shape(
    __hb_ann: SparseAnnotationPass, __hb_ret: StreamShapeChoice
):
...
def parallelization_after_level_0(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
...
def parallelization_after_level_1(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_2(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_3(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_4(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_5(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_6(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_7(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_8(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_9(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_10(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_11(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_12(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_13(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_14(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def parallelization_after_level_15(
    __hb_par: ParFactorChoice, __hb_ret: ParallelizationPass
):
    print("Parallelization.")
...
def use_scorch_loop_order(__hb_pass: ParallelizationPass, __hb_ret: LoopOrderChoice):
    # MLIR_PROGRAM is the module-level global the codegen emits for the
    # MlirProgram input; read the hardcoded cin_expression off it directly.
    expr = MLIR_PROGRAM.cin_expression
    # hardcoded for now
    formats = {"t0": "ss", "t1": "dd", "t2": "dd", "tOut1": "dd"}
    lhs_str, rhs_str = (s.strip() for s in expr.split("="))
    ...
    order = Scheduler.select_loop_order(cin)
    order = ",".join([iv.name for iv in order])

    ScheduleState.set_values(dataflow_ordering=order)
    print("Choose scorch-generated dataflow loop order.")
