...
var $author$project$Incoming$valueType = A2(
	...
	function (s) {
		switch (s) {
			case 'Bool':
				return $elm$json$Json$Decode$succeed($author$project$Core$VTBool);
			case 'Int':
				return $elm$json$Json$Decode$succeed($author$project$Core$VTInt);
			case 'Str':
				return $elm$json$Json$Decode$succeed($author$project$Core$VTStr);
			default:
				return $elm$json$Json$Decode$fail('Unknown value type');
		}
	},
...
var $author$project$Cell$Code = function (a) {
	return {$: 'Code', a: a};
};
var $author$project$Cell$ChoiceCell = F5(
...
var $author$project$Incoming$decodeMetadataChoice = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Cell$MetadataChoice,
	A2(
		$elm$json$Json$Decode$field,
		'metadata',
...
var $author$project$Incoming$decodeChoiceCell = A6(
	...
	A2($elm$json$Json$Decode$field, 'var_name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'type_title', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'type_description',
		$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string)),
...
var $author$project$Incoming$decodeCell = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			...
			$elm$json$Json$Decode$field,
			'Code',
			A2($elm$json$Json$Decode$map, $author$project$Cell$Code, $author$project$Incoming$decodeCodeCell)),
			A2(
			$elm$json$Json$Decode$field,
			'Choice',
			A2($elm$json$Json$Decode$map, $author$project$Cell$Choice, $author$project$Incoming$decodeChoiceCell))
		]));
var $author$project$Incoming$decodePbnStatus = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Incoming$PbnStatusMessage,
	A2(
		$elm$json$Json$Decode$field,
		'cells',
		$elm$json$Json$Decode$list($author$project$Incoming$decodeCell)),
	A2(
		$elm$json$Json$Decode$field,
		'output',
		$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string)),
	A2($elm$json$Json$Decode$field, 'can_undo', $elm$json$Json$Decode$bool));
var $author$project$Incoming$iPbnSpeculativeStatus_ = _Platform_incomingPort('iPbnSpeculativeStatus_', $elm$json$Json$Decode$value);
var $author$project$Incoming$iPbnSpeculativeStatus = function (f) {
	return $author$project$Incoming$iPbnSpeculativeStatus_(
		A2(
			...
			[
				...
				function (psResult) {
					if (psResult.$ === 'Ok') {
						var ps = psResult.a;
						return A2(
							$author$project$Update$BackendSentPbnStatus,
							{speculative: false},
							ps);
					} else {
						var e = psResult.a;
						var _v2 = A2($elm$core$Debug$log, 'status error', e);
						return A2(
							$author$project$Update$BackendSentPbnStatus,
							{speculative: false},
							{canUndo: false, cells: _List_Nil, output: $elm$core$Maybe$Nothing});
					}
				}),
				$author$project$Incoming$iPbnSpeculativeStatus(
				function (psResult) {
					if (psResult.$ === 'Ok') {
						var ps = psResult.a;
						return A2(
						...
						var e = psResult.a;
						var _v4 = A2($elm$core$Debug$log, 'speculative status error', e);
						return A2(
							$author$project$Update$BackendSentPbnStatus,
							{speculative: true},
							{canUndo: false, cells: _List_Nil, output: $elm$core$Maybe$Nothing});
...
var $author$project$Util$unique = function (xs) {
	unique:
	while (true) {
		if (!xs.b) {
			return _List_Nil;
			...
			var hd = xs.a;
			var tl = xs.b;
			if (A2($elm$core$List$member, hd, tl)) {
				var $temp$xs = tl;
				xs = $temp$xs;
				continue unique;
			} else {
	...
	function (pred, xs) {
		return A2(
			...
			function (_v0) {
				var i = _v0.a;
				var x = _v0.b;
				return A2(pred, i, x) ? $elm$core$Maybe$Just(x) : $elm$core$Maybe$Nothing;
			},
			A2(
				$elm$core$List$indexedMap,
				F2(
...
var $author$project$Update$setFunctionChoice = F2(
	function (_v0, model) {
		var cellIndex = _v0.cellIndex;
		var functionIndex = _v0.functionIndex;
		var _v1 = model.pbnStatus;
		if (_v1.$ === 'Nothing') {
			return model;
		} else {
			var status = _v1.a;
						...
						F2(
							function (i, c) {
								if (c.$ === 'Code') {
									...
									var ch = c.a;
									return _Utils_eq(i, cellIndex) ? $author$project$Cell$Choice(
										_Utils_update(
											ch,
											{selectedFunctionChoice: functionIndex})) : c;
								}
							}),
						status.cells)
				});
			return _Utils_update(
				model,
				{
					pbnStatus: $elm$core$Maybe$Just(newStatus)
				});
		}
	});
var $author$project$Update$setMetadataChoice = F2(
	function (_v0, model) {
		var cellIndex = _v0.cellIndex;
		var functionIndex = _v0.functionIndex;
		var metadataIndex = _v0.metadataIndex;
		var _v1 = model.pbnStatus;
		if (_v1.$ === 'Nothing') {
			return model;
		} else {
			var status = _v1.a;
			var updateFunctionChoices = $elm$core$List$indexedMap(
				F2(
					function (fci, fc) {
						return _Utils_eq(fci, functionIndex) ? _Utils_update(
							fc,
							{selectedMetadataChoice: metadataIndex}) : fc;
					}));
			var updateCells = $elm$core$List$indexedMap(
				F2(
					function (i, c) {
						if (c.$ === 'Code') {
							return c;
							...
							return _Utils_eq(i, cellIndex) ? $author$project$Cell$Choice(
								_Utils_update(
									ch,
									{
										functionChoices: updateFunctionChoices(ch.functionChoices)
									})) : c;
						}
					}));
			var newStatus = _Utils_update(
				status,
				{
					cells: updateCells(status.cells)
				});
			return _Utils_update(
				model,
				{
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UserSetStep':
				...
				var newModel = function () {
					...
					if (_v1.$ === 'Nothing') {
						...
						return _Utils_update(
							model,
							{pbnStatus: $elm$core$Maybe$Nothing, program: newProgram});
					}
				}();
			...
			case 'UserClearedStep':
				var pi = msg.a;
				var intermediateProgram = A3($author$project$Core$set, pi, $elm$core$Maybe$Nothing, model.program);
				var newProgram = _Utils_update(
					intermediateProgram,
					{goal: $elm$core$Maybe$Nothing});
			...
			case 'UserSelectedFunction':
				...
				var functionIndex = msg.b;
				var speculateChoice = msg.c;
				return _Utils_Tuple2(
					A2(
						$author$project$Update$setFunctionChoice,
						{
							cellIndex: cellIndex,
							functionIndex: $elm$core$Maybe$Just(functionIndex)
						},
						model),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								if (speculateChoice.$ === 'Just') {
									...
									return $author$project$Outgoing$oPbnSpeculate(
										{choice: choice});
								} else {
			...
			case 'UserDeselectedFunction':
				var cellIndex = msg.a.cellIndex;
				return _Utils_Tuple2(
					A2(
						$author$project$Update$setFunctionChoice,
						{cellIndex: cellIndex, functionIndex: $elm$core$Maybe$Nothing},
						_Utils_update(
							model,
							{speculativePbnStatus: $elm$core$Maybe$Nothing})),
					$author$project$Outgoing$oScrollIntoView(
			...
			case 'UserSelectedMetadata':
				...
				var metadataIndex = msg.b;
				return _Utils_Tuple2(
					A2(
						$author$project$Update$setMetadataChoice,
						{cellIndex: cellIndex, functionIndex: functionIndex, metadataIndex: metadataIndex},
						model),
					$elm$core$Platform$Cmd$none);
			...
			case 'BackendSentPbnStatus':
				...
				var status = msg.b;
				return _Utils_Tuple2(
					speculative ? _Utils_update(
						model,
						{
							speculativePbnStatus: $elm$core$Maybe$Just(status)
						}) : _Utils_update(
						model,
						{
...
var $author$project$View$cell = F2(
	function (ctx, c) {
		if (c.$ === 'Code') {
			...
			if (_Utils_eq(
				$elm$core$Maybe$Just(ctx.index),
				ctx.lastChoiceIndex)) {
				var _v1 = ctx.diff;
				if ((_v1.$ === 'Just') && (_v1.a.b.$ === 'Code')) {
					var _v2 = _v1.a;
					var specCode = _v2.b.a;
					return A2(
						$elm$html$Html$section,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('active-choice-cell'),
								$elm$html$Html$Attributes$class('cell'),
								$elm$html$Html$Attributes$class('speculating')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(specCode.title)
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('active-choice-cell'),
								$elm$html$Html$Attributes$class('cell'),
								$elm$html$Html$Attributes$class('waiting-for-speculation')
							]),
						_List_fromArray(
							[
								A2(
								...
								$elm$html$Html$text(' Choose code for this slot in the control panel')
							]));
				}
			} else {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('cell'),
							$elm$html$Html$Attributes$class('dormant')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('The code that goes here will be filled out using the control panel later')
						]));
			}
		}
	});
...
var $author$project$Util$findFirst2 = F3(
	function (f, xs, ys) {
		return A2(
...
var $author$project$Util$justs = function (xs) {
	return A2($elm$core$List$filterMap, $elm$core$Basics$identity, xs);
};
var $author$project$Util$last = function (xs) {
	return $elm$core$List$head(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('pane', true),
							_Utils_Tuple2('pane-inactive', !active)
						]))
				]),
			body);
	});
...
var $author$project$View$panel = F3(
	function (fraction, attrs, p) {
		var bgLine = A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('bg-line')
				]),
			_List_Nil);
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						...
						p.header)),
					A2($elm$html$Html$section, _List_Nil, p.body),
					function () {
					var _v0 = p.footer;
					if (_v0.$ === 'Just') {
						var f = _v0.a;
						return A2($elm$html$Html$footer, _List_Nil, f);
					} else {
...
var $author$project$View$DuckDuckGo = {$: 'DuckDuckGo'};
var $author$project$View$Google = {$: 'Google'};
var $author$project$Update$UserSelectedFunction = F3(
	function (a, b, c) {
		return {$: 'UserSelectedFunction', a: a, b: b, c: c};
	});
...
var $author$project$View$searchEngineUrl = F2(
	function (se, query) {
		var prefix = function () {
			if (se.$ === 'Google') {
		...
		var encodedQuery = A3($elm$core$String$replace, ' ', '+', query);
		return _Utils_ap(prefix, encodedQuery);
	});
...
var $author$project$View$functionChoice = F2(
	function (ctx, fc) {
		var maybePbnChoiceIndex = A2(
			...
			A2($author$project$Util$at, fc.selectedMetadataChoice, fc.metadataChoices));
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('selected', ctx.selected)
						]))
				]),
			_List_fromArray(
				[
						...
						[
							...
							if (_v0.$ === 'Just') {
								...
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('use')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(' '),
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('tool-search-info')
						]),
					$elm$core$List$concat(
						_List_fromArray(
							[
								function () {
								if (fc.search) {
									var searchEngineQuery = fc.functionTitle + ' bioinformatics';
									return _List_fromArray(
										[
											A2(
											$elm$html$Html$li,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src('assets/google.webp')
														]),
													_List_Nil),
													A2(
													$elm$html$Html$a,
													_List_fromArray(
														[
															...
															A2($author$project$View$searchEngineUrl, $author$project$View$Google, searchEngineQuery))
														]),
													_List_fromArray(
														[
															$elm$html$Html$text('Google')
														]))
												])),
											A2(
											$elm$html$Html$li,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src('assets/duckduckgo.png')
														]),
													_List_Nil),
													A2(
													$elm$html$Html$a,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$href(
															A2($author$project$View$searchEngineUrl, $author$project$View$DuckDuckGo, searchEngineQuery))
														]),
													_List_fromArray(
														[
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$src('assets/google_scholar.png')
														]),
													_List_Nil),
													A2(
													$elm$html$Html$a,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$href('https://scholar.google.com/scholar?cites=' + gsid)
														]),
													_List_fromArray(
														[
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2($author$project$View$markdown, _List_Nil, desc),
											$elm$core$List$isEmpty(fc.hyperparameters) ? $elm$html$Html$text('') : A2(
											$elm$html$Html$details,
											_List_Nil,
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text('Parameters you’ll need to set…')
														])),
													A2(
													$elm$html$Html$div,
													_List_fromArray(
												...
												return A2(
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$elm$html$Html$text('Citation information...')
																])),
															A2(
															$elm$html$Html$div,
															_List_fromArray(
											...
											($elm$core$List$length(fc.metadataChoices) > 1) ? $elm$html$Html$text('TODO') : $elm$html$Html$text('')
										]))
								]));
					} else {
						return $elm$html$Html$text('');
...
var $author$project$Util$asSingleton = function (xs) {
	if (xs.b && (!xs.b.b)) {
		var x = xs.a;
		return $elm$core$Maybe$Just(x);
	} else {
...
var $author$project$View$factSelect = F5(
	function (lib, blankName, pi, mfact, enabled) {
		var selectedName = function () {
			if (mfact.$ === 'Just') {
				var fact = mfact.a;
				return $elm$core$Maybe$Just(fact.name);
			} else {
				return $elm$core$Maybe$Nothing;
			}
		}();
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$core$Maybe$withDefault, blankName, selectedName)),
					$elm$html$Html$Events$onInput(
					function (key) {
						return _Utils_eq(key, blankName) ? $author$project$Update$UserClearedStep(pi) : A2($author$project$Update$UserSetStep, pi, key);
					})
				]),
			options);
	});
var $author$project$Util$joinMaybe = function (mmx) {
	if (mmx.$ === 'Nothing') {
		return $elm$core$Maybe$Nothing;
	} else {
		if (mmx.a.$ === 'Nothing') {
...
var $author$project$View$goalSpecification = function (model) {
	...
	return {
		...
		footer: $elm$core$Maybe$Just(
			_List_fromArray(
				[
					$author$project$View$startNavigationButton(model)
				])),
		header: _List_fromArray(
			[
				A2(
...
var $author$project$View$mainMenuBar = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('menu-bar-left')
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('launch-notebook.sh'),
											$elm$html$Html$Attributes$download('launch-notebook.sh')
										]),
									_List_fromArray(
										[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('menu-bar-right')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$View$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$View$mainMenuBar,
				A2(
				$elm$html$Html$main_,
				_List_Nil,
				_List_fromArray(
